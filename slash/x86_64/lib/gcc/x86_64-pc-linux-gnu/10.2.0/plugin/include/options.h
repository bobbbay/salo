...
enum opt_code
{
  ...
  OPT_list = 1595,                           /* -list */
  OPT_m128bit_long_double = 1596,            /* -m128bit-long-double */
  OPT_m16 = 1597,                            /* -m16 */
  OPT_m32 = 1598,                            /* -m32 */
  OPT_m3dnow = 1599,                         /* -m3dnow */
  OPT_m3dnowa = 1600,                        /* -m3dnowa */
  OPT_m64 = 1601,                            /* -m64 */
  OPT_m80387 = 1602,                         /* -m80387 */
  OPT_m8bit_idiv = 1603,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1604,             /* -m96bit-long-double */
  OPT_mabi_ = 1605,                          /* -mabi= */
  OPT_mabm = 1606,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1607,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1608,                 /* -maddress-mode= */
  OPT_madx = 1609,                           /* -madx */
  OPT_maes = 1610,                           /* -maes */
  OPT_malign_data_ = 1611,                   /* -malign-data= */
  OPT_malign_double = 1612,                  /* -malign-double */
  OPT_malign_functions_ = 1613,              /* -malign-functions= */
  OPT_malign_jumps_ = 1614,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1615,                  /* -malign-loops= */
  OPT_malign_stringops = 1616,               /* -malign-stringops */
  OPT_mandroid = 1617,                       /* -mandroid */
  OPT_march_ = 1618,                         /* -march= */
  OPT_masm_ = 1619,                          /* -masm= */
  OPT_mavx = 1620,                           /* -mavx */
  OPT_mavx2 = 1621,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1622,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1623,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1624,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1625,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1626,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1627,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1628,                      /* -mavx512bw */
  OPT_mavx512cd = 1629,                      /* -mavx512cd */
  OPT_mavx512dq = 1630,                      /* -mavx512dq */
  OPT_mavx512er = 1631,                      /* -mavx512er */
  OPT_mavx512f = 1632,                       /* -mavx512f */
  OPT_mavx512ifma = 1633,                    /* -mavx512ifma */
  OPT_mavx512pf = 1634,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1635,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1636,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1637,                      /* -mavx512vl */
  OPT_mavx512vnni = 1638,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1639,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1640,               /* -mavx512vpopcntdq */
  OPT_mbionic = 1641,                        /* -mbionic */
  OPT_mbmi = 1642,                           /* -mbmi */
  ...
  /* OPT_mcpu_ = 1653, */                    /* -mcpu= */
  OPT_mcrc32 = 1654,                         /* -mcrc32 */
  OPT_mcx16 = 1655,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1656,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1657,            /* -mdump-tune-features */
  OPT_menqcmd = 1658,                        /* -menqcmd */
  OPT_mf16c = 1659,                          /* -mf16c */
  OPT_mfancy_math_387 = 1660,                /* -mfancy-math-387 */
  OPT_mfentry = 1661,                        /* -mfentry */
  OPT_mfentry_name_ = 1662,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1663,               /* -mfentry-section= */
  OPT_mfma = 1664,                           /* -mfma */
  OPT_mfma4 = 1665,                          /* -mfma4 */
  OPT_mforce_drap = 1666,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1667,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1668,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1669,                       /* -mfpmath= */
  OPT_mfsgsbase = 1670,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1671,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1672, */              /* -mfused-madd */
  OPT_mfxsr = 1673,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1674,             /* -mgeneral-regs-only */
  OPT_mgfni = 1675,                          /* -mgfni */
  OPT_mglibc = 1676,                         /* -mglibc */
  OPT_mhard_float = 1677,                    /* -mhard-float */
  OPT_mhle = 1678,                           /* -mhle */
  OPT_miamcu = 1679,                         /* -miamcu */
  OPT_mieee_fp = 1680,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1681,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1682,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1683,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1684,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1685,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1686,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1687, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1688,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1689,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1690,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1691,                /* -mlong-double-80 */
  OPT_mlwp = 1692,                           /* -mlwp */
  OPT_mlzcnt = 1693,                         /* -mlzcnt */
  OPT_mmanual_endbr = 1694,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1695,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1696,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1697,                  /* -mmitigate-rop */
  OPT_mmmx = 1698,                           /* -mmmx */
  OPT_mmovbe = 1699,                         /* -mmovbe */
  OPT_mmovdir64b = 1700,                     /* -mmovdir64b */
  OPT_mmovdiri = 1701,                       /* -mmovdiri */
  OPT_mmpx = 1702,                           /* -mmpx */
  OPT_mms_bitfields = 1703,                  /* -mms-bitfields */
  ...
  OPT_mnop_mcount = 1712,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1713,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1714,                          /* -mpc32 */
  OPT_mpc64 = 1715,                          /* -mpc64 */
  OPT_mpc80 = 1716,                          /* -mpc80 */
  OPT_mpclmul = 1717,                        /* -mpclmul */
  OPT_mpcommit = 1718,                       /* -mpcommit */
  OPT_mpconfig = 1719,                       /* -mpconfig */
  OPT_mpku = 1720,                           /* -mpku */
  OPT_mpopcnt = 1721,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1722, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1723,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1724,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1725,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1726,                        /* -mprfchw */
  OPT_mptwrite = 1727,                       /* -mptwrite */
  OPT_mpush_args = 1728,                     /* -mpush-args */
  OPT_mrdpid = 1729,                         /* -mrdpid */
  OPT_mrdrnd = 1730,                         /* -mrdrnd */
  OPT_mrdseed = 1731,                        /* -mrdseed */
  OPT_mrecip = 1732,                         /* -mrecip */
  OPT_mrecip_ = 1733,                        /* -mrecip= */
  OPT_mrecord_mcount = 1734,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1735,                 /* -mrecord-return */
  OPT_mred_zone = 1736,                      /* -mred-zone */
  OPT_mregparm_ = 1737,                      /* -mregparm= */
  OPT_mrtd = 1738,                           /* -mrtd */
  OPT_mrtm = 1739,                           /* -mrtm */
  OPT_msahf = 1740,                          /* -msahf */
  OPT_msgx = 1741,                           /* -msgx */
  OPT_msha = 1742,                           /* -msha */
  OPT_mshstk = 1743,                         /* -mshstk */
  OPT_mskip_rax_setup = 1744,                /* -mskip-rax-setup */
  OPT_msoft_float = 1745,                    /* -msoft-float */
  OPT_msse = 1746,                           /* -msse */
  OPT_msse2 = 1747,                          /* -msse2 */
  OPT_msse2avx = 1748,                       /* -msse2avx */
  OPT_msse3 = 1749,                          /* -msse3 */
  OPT_msse4 = 1750,                          /* -msse4 */
  OPT_msse4_1 = 1751,                        /* -msse4.1 */
  OPT_msse4_2 = 1752,                        /* -msse4.2 */
  OPT_msse4a = 1753,                         /* -msse4a */
  /* OPT_msse5 = 1754, */                    /* -msse5 */
  OPT_msseregparm = 1755,                    /* -msseregparm */
  OPT_mssse3 = 1756,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1757,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1758, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1759,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1760, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1761,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1762,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1763,            /* -mstringop-strategy= */
  OPT_mstv = 1764,                           /* -mstv */
  OPT_mtbm = 1765,                           /* -mtbm */
  OPT_mtls_dialect_ = 1766,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1767,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1768,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1769,                         /* -mtune= */
  OPT_muclibc = 1770,                        /* -muclibc */
  OPT_mvaes = 1771,                          /* -mvaes */
  OPT_mveclibabi_ = 1772,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1773,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1774,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1775,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1776,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1777,                      /* -mwbnoinvd */
  OPT_mx32 = 1778,                           /* -mx32 */
  OPT_mxop = 1779,                           /* -mxop */
  OPT_mxsave = 1780,                         /* -mxsave */
  OPT_mxsavec = 1781,                        /* -mxsavec */
  OPT_mxsaveopt = 1782,                      /* -mxsaveopt */
  OPT_mxsaves = 1783,                        /* -mxsaves */
  OPT_n = 1784,                              /* -n */
  OPT_name_sort = 1785,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1786,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1787,              /* -no-integrated-cpp */
  OPT_no_pie = 1788,                         /* -no-pie */
  OPT_nocpp = 1789,                          /* -nocpp */
  OPT_nodefaultlibs = 1790,                  /* -nodefaultlibs */
  OPT_nolibc = 1791,                         /* -nolibc */
  OPT_nophoboslib = 1792,                    /* -nophoboslib */
  OPT_nostartfiles = 1793,                   /* -nostartfiles */
  OPT_nostdinc = 1794,                       /* -nostdinc */
  OPT_nostdinc__ = 1795,                     /* -nostdinc++ */
  OPT_nostdlib = 1796,                       /* -nostdlib */
  OPT_o = 1797,                              /* -o */
  OPT_objects = 1798,                        /* -objects */
  OPT_p = 1799,                              /* -p */
  OPT_pass_exit_codes = 1800,                /* -pass-exit-codes */
  /* OPT_pedantic = 1801, */                 /* -pedantic */
  OPT_pedantic_errors = 1802,                /* -pedantic-errors */
  OPT_pg = 1803,                             /* -pg */
  OPT_pie = 1804,                            /* -pie */
  OPT_pipe = 1805,                           /* -pipe */
  OPT_posix = 1806,                          /* -posix */
  OPT_print_file_name_ = 1807,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1808,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1809,          /* -print-multi-directory */
  OPT_print_multi_lib = 1810,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1811,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1812,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1813,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1814,               /* -print-prog-name= */
  OPT_print_search_dirs = 1815,              /* -print-search-dirs */
  OPT_print_sysroot = 1816,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1817,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1818,                    /* -print-value */
  OPT_profile = 1819,                        /* -profile */
  OPT_pthread = 1820,                        /* -pthread */
  OPT_quiet = 1821,                          /* -quiet */
  OPT_r = 1822,                              /* -r */
  OPT_rdynamic = 1823,                       /* -rdynamic */
  ...
  OPT_std_c__2a = 1856,                      /* -std=c++2a */
  OPT_std_c__98 = 1857,                      /* -std=c++98 */
  OPT_std_c11 = 1858,                        /* -std=c11 */
  OPT_std_c17 = 1859,                        /* -std=c17 */
  /* OPT_std_c18 = 1860, */                  /* -std=c18 */
  /* OPT_std_c1x = 1861, */                  /* -std=c1x */
  OPT_std_c2x = 1862,                        /* -std=c2x */
  /* OPT_std_c89 = 1863, */                  /* -std=c89 */
  OPT_std_c90 = 1864,                        /* -std=c90 */
  OPT_std_c99 = 1865,                        /* -std=c99 */
  /* OPT_std_c9x = 1866, */                  /* -std=c9x */
  OPT_std_f2003 = 1867,                      /* -std=f2003 */
  OPT_std_f2008 = 1868,                      /* -std=f2008 */
  OPT_std_f2008ts = 1869,                    /* -std=f2008ts */
  OPT_std_f2018 = 1870,                      /* -std=f2018 */
  OPT_std_f95 = 1871,                        /* -std=f95 */
  OPT_std_gnu = 1872,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1873, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1874, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1875,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1876,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1877,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1878, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1879, */              /* -std=gnu++1z */
  /* OPT_std_gnu__20 = 1880, */              /* -std=gnu++20 */
  OPT_std_gnu__2a = 1881,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1882,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1883,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1884,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1885, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1886, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1887,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1888, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1889,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1890,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1891, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1892, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1893,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1894, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1895, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1896, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1897, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1898, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1899,                     /* -std=legacy */
  OPT_symbol_ = 1900,                        /* -symbol= */
  OPT_symbolic = 1901,                       /* -symbolic */
  OPT_t = 1902,                              /* -t */
  OPT_time = 1903,                           /* -time */
  OPT_time_ = 1904,                          /* -time= */
  OPT_tno_android_cc = 1905,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1906,                 /* -tno-android-ld */
  OPT_traditional = 1907,                    /* -traditional */
  OPT_traditional_cpp = 1908,                /* -traditional-cpp */
  OPT_tree_stats = 1909,                     /* -tree-stats */
  OPT_trigraphs = 1910,                      /* -trigraphs */
  OPT_type_stats = 1911,                     /* -type-stats */
  OPT_u = 1912,                              /* -u */
  OPT_undef = 1913,                          /* -undef */
  OPT_v = 1914,                              /* -v */
  OPT_version = 1915,                        /* -version */
  OPT_w = 1916,                              /* -w */
  OPT_wrapper = 1917,                        /* -wrapper */
  OPT_x = 1918,                              /* -x */
  OPT_z = 1919,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
